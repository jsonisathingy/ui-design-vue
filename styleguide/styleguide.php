...
<div id="app">
		<nav class="navbar navbar-expand-lg navbar-light bg-white">
			<div class="navbar-brand"><img src="images/horizontal-logo.svg" width="131" class="mr-2 mb-2"><span class="pipe">|</span><span class="text-muted">Design System</span></div>
		</nav>
		<!-- Content -->
		<div class="container">
				<section class="my-5">
				...
				<section class="my-5">
						<div class="row">
								...
								<div class="col-sm-9">
										...
										<div class="mt-4">
											<p>Body text lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</p>
